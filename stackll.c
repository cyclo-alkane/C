...
//Insert a Node into Stack (PUSH) LIFO/FILO
//Create a new node
//Head Node
//Change Head node after every insertion
void create_list()
//Create or append 'n' nodes
{
int n;
...
void display()
//Traverse the stack & fetch all its elements in order
{
if(first==NULL) printf("Stack is empty\n");
//Stack underflow
else
{
...
void delete_begin()
//Delete a Node from Stack (POP) LIFO/FILO
{
if(first!=NULL)
{
if(first->next==NULL) first=NULL;
//When the stack has one node
else
{
ptr=first->next;
first=ptr;
